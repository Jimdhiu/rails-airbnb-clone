...
ActiveRecord::Schema.define(version: 20170815151703) do
  ...
  create_table "boat_options", force: :cascade do |t|
    t.integer "option_id"
    t.integer "boat_id"
    t.index ["boat_id"], name: "index_boat_options_on_boat_id", using: :btree
    t.index ["option_id"], name: "index_boat_options_on_option_id", using: :btree
  end
  ...
  add_foreign_key "boat_options", "options"
